<div id="general">
  ...
  <div id="columnaselectora">
     ...
     <div id="selectores">
        <div id="patentes1">
           <div class="patentes"><a href="<?=base_url()?>trailer/view/1">JL-81-70</a></div>
           <div class="patentes"><a href="esquema_general.html">ZK DF 09</a></div>
  ...
  <div id="columnab">
    ...
    <div id="iframe"><iframe id="iframe" frameborder="0" src="<?php echo base_url();?>trailer/alarms_events"></iframe></div>  
  </div>
</div>